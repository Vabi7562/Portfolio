...
const IMAGES = [
  "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=300&q=80",
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full overflow-hidden" style={{ background: "transparent" }}>
      <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: "1000px" }}>
        ...
        >
          <h2
            className="text-3xl md:text-5xl font-light text-white tracking-tight mb-4"
            style={{ fontFamily: "Archivo, sans-serif" }}
          >
            Through the lens.
          </h2>
          <p className="text-sm md:text-base text-gray-400 max-w-lg leading-relaxed">
            A curated collection of moments captured in light and shadow.
          </p>
        </motion.div>
